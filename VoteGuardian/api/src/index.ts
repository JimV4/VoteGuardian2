...
export class VoteGuardianAPI implements DeployedVoteGuardianAPI {
  ...
  private constructor(
    ...
    this.state$ = combineLatest(
      [
        ...
        from(providers.privateStateProvider.get('voteGuardianPrivateState5') as Promise<VoteGuardianPrivateState>),
      ],
  ...
  //     await providers.privateStateProvider.set('voteGuardianPrivateState5', newPrivateState);
  //   }
  // }
}
