...
class _MerkleTreePathEntry_0 {
  ...
  toValue(value_0) {
    return _descriptor_7.toValue(value_0.sibling).concat(_descriptor_4.toValue(value_0.goes_left));
  }
}
...
class Contract {
  ...
  #_public_key_0(context, partialProofData, sk_0) {
    return this.#_persistentHash_1(context, partialProofData, sk_0);
  }
